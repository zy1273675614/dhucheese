...
<div class="mobile">
  ...
  <div class="w main">
  	<form id="frm_login" method="get" action="login">
        <div class="item item-username">
          <input id="username" class="txt-input txt-username" type="text" placeholder="请输入用户名/邮箱/手机号" value="" name="user.username">
          <b class="input-close" style="display: none;"></b> </div>
        <div class="item item-password">
          <input id="password" class="txt-input txt-password ciphertext" type="password" placeholder="请输入密码" name="user.password" style="display: inline;">
  ...
  <div class="copyright">Copyright © 2016-2018 奶酪网 m.178hui.com 版权所有</div>
</div>
</body>
</html>
    <script type="text/javascript" >
